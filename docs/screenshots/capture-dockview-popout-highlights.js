...
(async () => {
  ...
  if (popoutPage) {
    ...
    console.log('Taking main page screenshot with dockview placeholder and highlights...');
    await mainPage.screenshot({
      path: `${screenshotDir}/discover3-highlights-dockview-popout-main.png`
    });

    // Take popout screenshot
    console.log('Taking popout window screenshot with highlights...');
    await popoutPage.screenshot({
      path: `${screenshotDir}/discover3-highlights-dockview-popout-window.png`
    });
    ...
    const popoutResized = await sharp(`${screenshotDir}/discover3-highlights-dockview-popout-window.png`)
      .resize(850, 450)
      .png()
      .toBuffer();
    ...
    await sharp(`${screenshotDir}/discover3-highlights-dockview-popout-main.png`)
      .composite([
        {
      ...
      .toFile(`${screenshotDir}/discover3-highlights-dockview-popout-composite.png`);
