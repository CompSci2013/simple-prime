...
(async () => {
  ...
  // Screenshot 1: Picker collapsed (default state)
  console.log('Taking screenshot 1: picker collapsed...');
  await page.screenshot({
    path: `${screenshotDir}/discover3-picker-collapsed.png`,
    fullPage: true
  });
  ...
  console.log('Taking screenshot 2: picker expanded with 10 rows...');
  await page.screenshot({
    path: `${screenshotDir}/discover3-picker-expanded.png`,
    fullPage: true
  });
