...
@Component({
    selector: 'app-discover3',
    standalone: true,
    templateUrl: './discover3.component.html',
...
export class Discover3Component<TFilters = any, TData = any, TStatistics = any>
  ...
  private readonly gridId = 'discover3';
  ...
  ngOnInit(): void {
    // Discover3 uses its own fixed panel order, not user preferences

    // Register picker configs with unique ID for this page
    const pickerConfigs = createAutomobilePickerConfigs(this.injector, 'discover3');
